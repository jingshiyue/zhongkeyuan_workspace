...
suite_dict = collections.OrderedDict([
    ...
    ("ftISCompare.ISCompareMN_*",["ftISCompare.ISCompareMN_SingleThread","ftISCompare.ISCompareMN_MultiThread",]),
    ("ftISCompare.ISCompareMNfaster_*",["ftISCompare.ISCompareMNfaster_SingleThread","ftISCompare.ISCompareMNfaster_MultiThread"]),
    ("ftISCompareMN.prepareFeatureAndPcaRapidlyUsingMultiThread",["ftISCompareMN.prepareFeatureAndPcaRapidlyUsingMultiThread",]),
    ("ftISCompareMN.ISCompareMN_*",["ftISCompareMN.ISCompareMN_*",]),
    ("ftISCompareMN.ISCompareMNfaster_*", ["ftISCompareMN.ISCompareMNfaster_*", ]),
...
def alynase_case_rest(case_content,**kwags): #OutResultCheck
    ...
    if imgPathA_same and imgPathB_same:
...
if __name__ == "__main__":
    ...
    # config.set("testbed","xls","123.xls")
