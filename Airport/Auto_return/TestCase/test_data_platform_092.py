...
from Airport.数据平台接口.数据分析.A_092安检通道安检口人数峰值分析查询 import *


class TestApiAnalysisChannelSecPeak(unittest.TestCase):
    """2.4.9.2安检口人数峰值分析"""
    ...
    def test_03(self):
        ...
        body1 = {
            "reqId": get_uuid(),
            "areaCode": "atAJ-aa",  # 通道编号(区域表里面的编号)
            "startTime": "20181012" + "06000000",
            "endTime": "20181023" + "06000000"
        }
        a = api_v1_analysis_channel_sec_peak(body1)
        dict_data = json.loads(a)
    ...
    def test_04(self):
        """验证startTime大于endTime时，服务器能正确响应"""
        body1 = {
            "reqId": get_uuid(),
            "areaCode": "atAJ-A",  # 通道编号(区域表里面的编号)
            "startTime": "20180912" + "06000000",
            "endTime": "20180520" + "06000000"
        }
        a = api_v1_analysis_channel_sec_peak(body1)
        dict_data = json.loads(a)
