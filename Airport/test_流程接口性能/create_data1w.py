...
while k < 10000:
    ...
    lk_cname = "shijian姓名" + str(jj)
    lk_date = produce_flight_date()
    lk_flight = "MMk" + str(jj)
    lk_id = "09875" + str(jj)
    lk_bdno = get_lk_bdno()
    ...
    aj_id_base_path = "E:/test1w/1比1id"
    aj_live_base_path = "E:/test1w/1比1live"
    list_name_picture = os.listdir("E:/test1w/id1w")
    live_list_name_picture = os.listdir("E:/test1w/live1w")
    try:
    ...
    m1 = to_base64("E:/test1w/id1w" + "/" + list_name_picture[k])
    m2 = to_base64("E:/test1w/live1w" + "/" + list_name_picture[k])
